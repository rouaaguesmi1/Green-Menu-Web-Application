 ...
 */
final class Version20240418024059 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE restauranttable CHANGE tableId tableid VARCHAR(255) NOT NULL, CHANGE restaurantId restaurantid VARCHAR(255) DEFAULT NULL, CHANGE isOccupied isoccupied TINYINT(1) NOT NULL');
