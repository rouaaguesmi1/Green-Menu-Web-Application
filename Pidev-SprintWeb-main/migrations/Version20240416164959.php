 ...
 */
final class Version20240416164959 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE restauranttable CHANGE tableId tableid VARCHAR(255) NOT NULL, CHANGE isOccupied isoccupied TINYINT(1) NOT NULL, CHANGE restaurantId restaurantid VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE donation (idDon INT AUTO_INCREMENT NOT NULL, idCamp INT DEFAULT NULL, valeurDon INT NOT NULL, idDonator INT DEFAULT NULL, history DATE DEFAULT NULL, INDEX idDonator_FK (idDonator), INDEX idCamp (idCamp), PRIMARY KEY(idDon)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
